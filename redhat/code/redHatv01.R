...
#https://www.kaggle.com/loisso/predicting-red-hat-business-value/lb-0-987-group-1-and-date-trick/code

rm(list = ls())

#https://www.kaggle.com/dmi3kno/predicting-red-hat-business-value/redhat-hack-in-plain-english-eda
#RedHat Hack in plain English

# load requied libraries --------------------------------------------------
library(data.table)
setwd("c:/repo/redtraindata/")
...
summary(allCompaniesAndDays)
head(allCompaniesAndDays, n=10L)
unique(allCompaniesAndDays$V1)
...
write.csv(testsetdt,"Submissionred.csv", row.names = FALSE)
