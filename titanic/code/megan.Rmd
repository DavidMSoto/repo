...
date: '6 March 2016'
buenos tricks como data janitor, pero ninguna validacion del modelo
...
no veo yo que esto sea una validacion de la imputacion, es mas interesante tener dos formas diferentes de 
inferir por ejemplo esta variable qeu se queda la cuarta .. por un lado la media de las edades en base a los titulos originales, MRAge, y por otro lado la edad inverida, IAge
...
full$Mother[full$Sex == 'female' & full$Parch > 0 & full$Age > 16 ] <- 'Mother' 
...
training.rows <- createDataPartition(train$Survived,  p = 0.8, list = FALSE) # *** changed
