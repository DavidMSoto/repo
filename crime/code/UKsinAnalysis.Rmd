...
allTime <-'../input/streetMetropolitan20102015.csv'
...
allTimedataset =fread(allTime, colClasses=c(Longitude="character",Latitude="character"),
        header=T, sep=",", verbose = FALSE, showProgress = TRUE) %>% as.data.frame() # SILENCE

allTimedataset$Context<-NULL #unnecessary



names(allTimedataset) <- c( "CrimeID"  , "Month"  ,  "Reportedby"    ,  "Fallswithin" ,  
...
allTimedataset = dataclean(allTimedataset)
