...
```
 "Offender sent to prison"           				      --> high crime             
 "Offender given conditional discharge"         	--> medium crime   	
 "Offender fined"                                	--> low crime 
 "Court result unavailable"                      	--> NA
 "Suspect charged as part of another case"        --> high crime    
 "Offender ordered to pay compensation"          	--> no serious crime     
 "Offender given suspended prison sentence"      	--> serious crime 
 "Offender given a drugs possession warning"     	--> drugs possession 
 "Offender given absolute discharge"             	--> drugs possession
 ...
 "Local resolution"                             
 "Offender deprived of property"                --> wtf
 "Offender given penalty notice"                --> low crime 
 "Awaiting court outcome"                       -->	NA		
